...
1. **TestFlightアプリのインストール**
   - App Storeで「TestFlight」を検索
   - Apple公式の無料アプリをダウンロード・インストール

**参加手順:**
1. **招待メールの確認**
   - 件名: 「[アプリ名] のベータ版テストへの招待」
   - ⚠️ 迷惑メールフォルダも確認してください

2. **招待の受諾**
   - メール内の「TestFlightで表示」リンクをタップ
   - TestFlightアプリが自動で開きます
   - 「承諾してテスト開始」をタップ

3. **アプリのインストール**
   - TestFlightアプリ内で「湯めぐり手帳」を選択
   - 「インストール」をタップ
   - 通常のアプリと同様にホーム画面に追加されます

**トラブルシューティング:**
- **招待メールが届かない場合**: 迷惑メールフォルダを確認
- **リンクが機能しない場合**: TestFlightアプリを最新版に更新
- **アプリが表示されない場合**: 招待の受諾が完了していない可能性
...
### Q: 招待メールが届きません
A: 以下を確認してください：
- **迷惑メールフォルダ**: Appleからのメールが迷惑メール扱いされる場合があります
- **Apple ID**: 招待時に使用したメールアドレスが現在のApple IDと一致しているか確認
- **受信設定**: メールの受信制限がないか確認

### Q: TestFlightアプリでアプリが表示されません
A: 以下の手順を試してください：
1. 招待メールのリンクを再度タップ
2. TestFlightアプリを最新版に更新
3. 招待の受諾が完了しているか確認
4. それでも解決しない場合は開発者に連絡

### Q: アプリの更新通知が来ません
A: TestFlightでは自動的に更新通知が送信されますが：
- TestFlightアプリを開いて手動確認
- 通知設定でTestFlightが許可されているか確認
